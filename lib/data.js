...
export const heroMedia = {
  // Option 1: Use external hosting (YouTube, Vimeo, CDN, etc.)
  // backgroundMediaUrl: "https://your-cdn.com/lib.mp4",
  
  // Option 2: Use YouTube (recommended for large videos)
  // backgroundMediaUrl: "https://www.youtube.com/watch?v=YOUR_VIDEO_ID",
  
  // Current: Local video (65MB - too large for git/deployment)
  backgroundMediaUrl: "/video/lib.mp4",
  posterImageUrl: "/placeholder.jpg",
}
